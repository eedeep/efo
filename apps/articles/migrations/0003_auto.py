...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field feature_sets on 'Article'
        db.create_table('articles_article_feature_sets', (
        ...
        db.create_unique('articles_article_feature_sets', ['article_id', 'featureset_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field feature_sets on 'Article'
        db.delete_table('articles_article_feature_sets')
