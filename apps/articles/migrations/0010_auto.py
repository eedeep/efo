...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field issues on 'Article'
        db.create_table('articles_article_issues', (
        ...
        db.create_unique('articles_article_issues', ['article_id', 'magazineissue_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field issues on 'Article'
        db.delete_table('articles_article_issues')
