...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.magazine_section'
        db.add_column('articles_article', 'magazine_section', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['articles.MagazineSection']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.magazine_section'
        db.delete_column('articles_article', 'magazine_section_id')
