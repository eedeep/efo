...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ArticleType.is_navigable'
        db.add_column('articles_articletype', 'is_navigable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'ArticleType.is_published'
        db.add_column('articles_articletype', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        ats = ArticleType.objects.all()
        for at in ats:
            at.is_published = True
            at.is_navigable = True
            at.save()
        

    def backwards(self, orm):
        
        # Deleting field 'ArticleType.is_navigable'
        db.delete_column('articles_articletype', 'is_navigable')

        # Deleting field 'ArticleType.is_published'
        db.delete_column('articles_articletype', 'is_published')
    ...
    models = {
        ...
        'articles.articletype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_navigable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
