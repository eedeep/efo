...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('articles_article', 'feature')

        # Adding field 'Article.publisher'
        db.add_column('articles_article', 'publisher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['colophon.Publisher'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('articles_article', 'feature', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Article.publisher'
        db.delete_column('articles_article', 'publisher_id')

        # Changing field 'Article.article_type'
        db.alter_column('articles_article', 'article_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=u'news', to=orm['articles.ArticleType']))
