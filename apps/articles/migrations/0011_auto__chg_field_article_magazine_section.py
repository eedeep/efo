...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field tags on 'ArticleType'
        db.create_table('articles_articletype_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('articletype', models.ForeignKey(orm['articles.articletype'], null=False)),
            ('tag', models.ForeignKey(orm['taggit.tag'], null=False))
        ))
        db.create_unique('articles_articletype_tags', ['articletype_id', 'tag_id'])

        # Changing field 'Article.magazine_section'
        db.alter_column('articles_article', 'magazine_section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.MagazineSection'], null=True))


    def backwards(self, orm):
        
        # Removing M2M table for field tags on 'ArticleType'
        db.delete_table('articles_articletype_tags')

        # Changing field 'Article.magazine_section'
        db.alter_column('articles_article', 'magazine_section_id', self.gf('django.db.models.fields.related.ForeignKey')(default='section', to=orm['articles.MagazineSection']))
    ...
    models = {
        'articles.article': {
            ...
            'issues': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['publications.MagazineIssue']", 'null': 'True', 'blank': 'True'}),
            'magazine_section': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['articles.MagazineSection']", 'null': 'True', 'blank': 'True'}),
