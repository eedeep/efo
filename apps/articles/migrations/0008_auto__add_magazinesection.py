...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MagazineSection'
        db.create_table('articles_magazinesection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('section_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('articles', ['MagazineSection'])


    def backwards(self, orm):
        
        # Deleting model 'MagazineSection'
        db.delete_table('articles_magazinesection')
