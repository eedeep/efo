...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.publish_on_AU'
        db.add_column('articles_article', 'publish_on_AU', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Article.publish_on_NZ'
        db.add_column('articles_article', 'publish_on_NZ', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding unique constraint on 'Article', fields ['old_id']
        db.create_unique('articles_article', ['old_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Article', fields ['old_id']
        db.delete_unique('articles_article', ['old_id'])

        # Deleting field 'Article.publish_on_AU'
        db.delete_column('articles_article', 'publish_on_AU')

        # Deleting field 'Article.publish_on_NZ'
        db.delete_column('articles_article', 'publish_on_NZ')
    ...
    models = {
        ...
        'features.sitefeaturearea': {
            ...
            'area': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
