...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ArticleType.name_plural'
        db.add_column('articles_articletype', 'name_plural', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ArticleType.name_plural'
        db.delete_column('articles_articletype', 'name_plural')
