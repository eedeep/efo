...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.feature_event'
        db.delete_column('events_event', 'feature_event')

        # Deleting field 'Event.feature'
        db.delete_column('events_event', 'feature')

        # Adding field 'Event.publisher'
        db.add_column('events_event', 'publisher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['colophon.Publisher'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Event.feature_event'
        db.add_column('events_event', 'feature_event', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.feature'
        db.add_column('events_event', 'feature', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
