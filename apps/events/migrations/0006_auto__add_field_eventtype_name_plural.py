...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventType.name_plural'
        db.add_column('events_eventtype', 'name_plural', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventType.name_plural'
        db.delete_column('events_eventtype', 'name_plural')
