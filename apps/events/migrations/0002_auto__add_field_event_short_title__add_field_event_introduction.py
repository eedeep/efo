...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.short_title'
        db.add_column('events_event', 'short_title', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)

        # Adding field 'Event.introduction'
        db.add_column('events_event', 'introduction', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.short_title'
        db.delete_column('events_event', 'short_title')

        # Deleting field 'Event.introduction'
        db.delete_column('events_event', 'introduction')
