...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.publish_on_AU'
        db.add_column('events_event', 'publish_on_AU', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.publish_on_NZ'
        db.add_column('events_event', 'publish_on_NZ', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.publish_on_AU'
        db.delete_column('events_event', 'publish_on_AU')

        # Deleting field 'Event.publish_on_NZ'
        db.delete_column('events_event', 'publish_on_NZ')
