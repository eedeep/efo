...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectRoleType.name_plural'
        db.add_column('projects_projectroletype', 'name_plural', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'ProjectSiteType.name_plural'
        db.add_column('projects_projectsitetype', 'name_plural', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'ProjectCategory.name_plural'
        db.add_column('projects_projectcategory', 'name_plural', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'ProjectType.name_plural'
        db.add_column('projects_projecttype', 'name_plural', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProjectRoleType.name_plural'
        db.delete_column('projects_projectroletype', 'name_plural')

        # Deleting field 'ProjectSiteType.name_plural'
        db.delete_column('projects_projectsitetype', 'name_plural')

        # Deleting field 'ProjectCategory.name_plural'
        db.delete_column('projects_projectcategory', 'name_plural')

        # Deleting field 'ProjectType.name_plural'
        db.delete_column('projects_projecttype', 'name_plural')
