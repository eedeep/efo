...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Project', fields ['old_id']
        db.create_unique('projects_project', ['old_id'])

        # Changing field 'ProjectIndividual.individual'
        db.alter_column('projects_projectindividual', 'individual_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        
        # Removing unique constraint on 'Project', fields ['old_id']
        db.delete_unique('projects_project', ['old_id'])

        # Changing field 'ProjectIndividual.individual'
        db.alter_column('projects_projectindividual', 'individual_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
