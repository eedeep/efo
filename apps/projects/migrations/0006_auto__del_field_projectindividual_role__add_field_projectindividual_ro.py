...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProjectIndividual.role'
        db.delete_column('projects_projectindividual', 'role_id')

        # Adding field 'ProjectIndividual.role_char'
        db.add_column('projects_projectindividual', 'role_char', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'ProjectIndividual.role_fk'
        db.add_column('projects_projectindividual', 'role_fk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectRoleType'], null=True, blank=True), keep_default=False)

        # Deleting field 'ProjectCompany.role'
        db.delete_column('projects_projectcompany', 'role_id')

        # Adding field 'ProjectCompany.role_char'
        db.add_column('projects_projectcompany', 'role_char', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'ProjectCompany.role_fk'
        db.add_column('projects_projectcompany', 'role_fk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectRoleType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ProjectIndividual.role'
        db.add_column('projects_projectindividual', 'role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectRoleType'], null=True, blank=True), keep_default=False)

        # Deleting field 'ProjectIndividual.role_char'
        db.delete_column('projects_projectindividual', 'role_char')

        # Deleting field 'ProjectIndividual.role_fk'
        db.delete_column('projects_projectindividual', 'role_fk_id')

        # Adding field 'ProjectCompany.role'
        db.add_column('projects_projectcompany', 'role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectRoleType'], null=True, blank=True), keep_default=False)

        # Deleting field 'ProjectCompany.role_char'
        db.delete_column('projects_projectcompany', 'role_char')

        # Deleting field 'ProjectCompany.role_fk'
        db.delete_column('projects_projectcompany', 'role_fk_id')
    ...
    models = {
        ...
        'projects.projectcompany': {
            ...
            'role_char': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'role_fk': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.ProjectRoleType']", 'null': 'True', 'blank': 'True'})
        },
