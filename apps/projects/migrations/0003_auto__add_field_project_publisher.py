...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.publisher'
        db.add_column('projects_project', 'publisher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['colophon.Publisher'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.publisher'
        db.delete_column('projects_project', 'publisher_id')
