...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectIndividual.custom_credit'
        db.add_column('projects_projectindividual', 'custom_credit', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Changing field 'ProjectIndividual.credit'
        db.alter_column('projects_projectindividual', 'credit', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Adding field 'ProjectCompany.custom_credit'
        db.add_column('projects_projectcompany', 'custom_credit', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Changing field 'ProjectCompany.credit'
        db.alter_column('projects_projectcompany', 'credit', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Deleting field 'ProjectIndividual.custom_credit'
        db.delete_column('projects_projectindividual', 'custom_credit')

        # Changing field 'ProjectIndividual.credit'
        db.alter_column('projects_projectindividual', 'credit', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Deleting field 'ProjectCompany.custom_credit'
        db.delete_column('projects_projectcompany', 'custom_credit')

        # Changing field 'ProjectCompany.credit'
        db.alter_column('projects_projectcompany', 'credit', self.gf('django.db.models.fields.CharField')(max_length=200))
