...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectRoleType.slug'
        db.alter_column('projects_projectroletype', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))

        # Changing field 'ProjectSiteType.slug'
        db.alter_column('projects_projectsitetype', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))

        # Changing field 'ProjectCategory.slug'
        db.alter_column('projects_projectcategory', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))

        # Changing field 'Project.slug'
        db.alter_column('projects_project', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))

        # Changing field 'ProjectType.slug'
        db.alter_column('projects_projecttype', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))


    def backwards(self, orm):
        
        # Changing field 'ProjectRoleType.slug'
        db.alter_column('projects_projectroletype', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'ProjectSiteType.slug'
        db.alter_column('projects_projectsitetype', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'ProjectCategory.slug'
        db.alter_column('projects_projectcategory', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'Project.slug'
        db.alter_column('projects_project', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'ProjectType.slug'
        db.alter_column('projects_projecttype', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
    ...
    models = {
        ...
        'projects.projectindividual': {
            ...
            'custom_credit': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'individual': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'organisation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['organisations.Organisation']"}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.Project']"}),
            'role': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.ProjectRoleType']", 'null': 'True', 'blank': 'True'})
        },
