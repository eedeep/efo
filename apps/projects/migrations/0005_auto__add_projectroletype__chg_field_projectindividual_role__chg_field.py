...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProjectRoleType'
        db.create_table('projects_projectroletype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, db_index=True)),
        ))
        db.send_create_signal('projects', ['ProjectRoleType'])

        # Renaming column for 'ProjectIndividual.role' to match new field type.
        db.rename_column('projects_projectindividual', 'role', 'role_id')
        # Changing field 'ProjectIndividual.role'
        db.alter_column('projects_projectindividual', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectRoleType'], null=True))

        # Adding index on 'ProjectIndividual', fields ['role']
        db.create_index('projects_projectindividual', ['role_id'])

        # Renaming column for 'ProjectCompany.role' to match new field type.
        db.rename_column('projects_projectcompany', 'role', 'role_id')
        # Changing field 'ProjectCompany.role'
        db.alter_column('projects_projectcompany', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectRoleType'], null=True))

        # Adding index on 'ProjectCompany', fields ['role']
        db.create_index('projects_projectcompany', ['role_id'])


    def backwards(self, orm):
        
        # Removing index on 'ProjectCompany', fields ['role']
        db.delete_index('projects_projectcompany', ['role_id'])

        # Removing index on 'ProjectIndividual', fields ['role']
        db.delete_index('projects_projectindividual', ['role_id'])

        # Deleting model 'ProjectRoleType'
        db.delete_table('projects_projectroletype')

        # Renaming column for 'ProjectIndividual.role' to match new field type.
        db.rename_column('projects_projectindividual', 'role_id', 'role')
        # Changing field 'ProjectIndividual.role'
        db.alter_column('projects_projectindividual', 'role', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Renaming column for 'ProjectCompany.role' to match new field type.
        db.rename_column('projects_projectcompany', 'role_id', 'role')
        # Changing field 'ProjectCompany.role'
        db.alter_column('projects_projectcompany', 'role', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
