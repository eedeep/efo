...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.short_title'
        db.add_column('projects_project', 'short_title', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)

        # Adding field 'Project.introduction'
        db.add_column('projects_project', 'introduction', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.short_title'
        db.delete_column('projects_project', 'short_title')

        # Deleting field 'Project.introduction'
        db.delete_column('projects_project', 'introduction')
