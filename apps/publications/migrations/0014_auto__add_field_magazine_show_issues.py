...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Magazine.show_issues'
        db.add_column('publications_magazine', 'show_issues', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Magazine.show_issues'
        db.delete_column('publications_magazine', 'show_issues')
    ...
    models = {
        'publications.magazine': {
            ...
            'show_issues': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
