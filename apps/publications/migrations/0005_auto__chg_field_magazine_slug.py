...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('publications_magazine', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))


    def backwards(self, orm):
        
        # Changing field 'Magazine.slug'
        db.alter_column('publications_magazine', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
