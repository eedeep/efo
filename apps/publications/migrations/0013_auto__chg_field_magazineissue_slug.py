...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MagazineIssue.slug'
        db.alter_column('publications_magazineissue', 'slug', self.gf('django.db.models.fields.SlugField')(default=datetime.date(2011, 2, 23), unique=True, max_length=250))


    def backwards(self, orm):
        
        # Changing field 'MagazineIssue.slug'
        db.alter_column('publications_magazineissue', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250, null=True))
