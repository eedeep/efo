...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MagazineIssue.cover_image_fb'
        db.delete_column('publications_magazineissue', 'cover_image_fb')

        # Adding field 'MagazineIssue.cover_image'
        db.add_column('publications_magazineissue', 'cover_image', self.gf('filebrowser.fields.FileBrowseField')(max_length=250, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'MagazineIssue.cover_image_fb'
        db.add_column('publications_magazineissue', 'cover_image_fb', self.gf('filebrowser.fields.FileBrowseField')(max_length=250, null=True, blank=True), keep_default=False)
