...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('images_image', 'title')

        # Adding field 'Image.user_credit'
        db.add_column('images_image', 'user_credit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'Image.custom_credit'
        db.add_column('images_image', 'custom_credit', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('images_image', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Deleting field 'Image.user_credit'
        db.delete_column('images_image', 'user_credit_id')

        # Deleting field 'Image.custom_credit'
        db.delete_column('images_image', 'custom_credit')
    ...
    models = {
        ...
        'images.image': {
            ...
            'custom_credit': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'feature': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user_credit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'images.projectimage': {
