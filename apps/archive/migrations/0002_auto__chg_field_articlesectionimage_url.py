...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArticleSectionImage.url'
        db.alter_column('archive_articlesectionimage', 'url', self.gf('filebrowser.fields.FileBrowseField')(max_length=250, null=True))


    def backwards(self, orm):
        
        # Changing field 'ArticleSectionImage.url'
        db.alter_column('archive_articlesectionimage', 'url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
