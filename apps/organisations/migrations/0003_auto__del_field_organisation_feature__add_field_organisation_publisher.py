...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Organisation.feature'
        db.delete_column('organisations_organisation', 'feature')

        # Adding field 'Organisation.publisher'
        db.add_column('organisations_organisation', 'publisher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['colophon.Publisher'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Organisation.feature'
        db.add_column('organisations_organisation', 'feature', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Organisation.publisher'
        db.delete_column('organisations_organisation', 'publisher_id')
