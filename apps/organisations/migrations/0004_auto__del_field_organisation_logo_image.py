...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Organisation.logo_image'
        db.delete_column('organisations_organisation', 'logo_image')


    def backwards(self, orm):
        
        # Adding field 'Organisation.logo_image'
        db.add_column('organisations_organisation', 'logo_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
