...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrganisationType.slug'
        db.alter_column('organisations_organisationtype', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))

        # Changing field 'Organisation.slug'
        db.alter_column('organisations_organisation', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))

        # Changing field 'OrganisationExpertise.slug'
        db.alter_column('organisations_organisationexpertise', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))


    def backwards(self, orm):
        
        # Changing field 'OrganisationType.slug'
        db.alter_column('organisations_organisationtype', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'Organisation.slug'
        db.alter_column('organisations_organisation', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'OrganisationExpertise.slug'
        db.alter_column('organisations_organisationexpertise', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
