...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('features_sitefeaturearea', 'area', self.gf('django.db.models.fields.CharField')(default='home', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteFeatureArea.area'
        db.delete_column('features_sitefeaturearea', 'area')
