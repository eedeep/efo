...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feature.feature_summary'
        db.add_column('features_feature', 'feature_summary', self.gf('django.db.models.fields.CharField')(default='Please enter a feature summary in the admin interface for this feature!', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Feature.caption'
        db.add_column('features_feature', 'caption', self.gf('django.db.models.fields.CharField')(default='Please enter a feature summary in the admin interface for this feature!', max_length=200), keep_default=False)

        # Deleting field 'Feature.feature_summary'
        db.delete_column('features_feature', 'feature_summary')
    ...
    models = {
        ...
        'features.feature': {
            ...
            'feature_summary': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
