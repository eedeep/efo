...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('features_featureset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['features.FeatureArea'])),
        ))
        db.send_create_signal('features', ['FeatureSet'])


    def backwards(self, orm):
        
        # Deleting model 'FeatureSet'
        db.delete_table('features_featureset')
